...
class TrainingRunManager:
    ...
    async def start(self, model: str, *, rematerialize: bool) -> dict[str, Any]:
...
async def api_run_start(body: StartRunBody) -> dict[str, Any]:
    try:
        return await _run_manager.start(body.model, rematerialize=body.rematerialize)
