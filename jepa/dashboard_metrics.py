...
from jepa.scripts.prediction_benchmark import _sample_indices, run_benchmark_for_checkpoint
...
def compute_move_benchmark_row(
    ...
    *,
    ...
    with h5py.File(val_h5, "r") as f:
        ...
        stats, _by_elo = run_benchmark_for_checkpoint(
            ckpt_path,
            f,
            indices,
            dev,
    ...
    if train_h5.is_file():
        with h5py.File(train_h5, "r") as tf:
            ...
            train_stats, _t_elo = run_benchmark_for_checkpoint(
                ckpt_path,
                tf,
                t_indices,
                dev,
        ...
        row["train"] = _json_sanitize(asdict(train_stats))
