"""Forward-pass benchmark for jepa2 dashboard."""
...
from jepa2.architectures import build_model, resolve_config_for_id
...
def benchmark_forward_pass(
    ...
    *,
    ...
    if checkpoint_path is not None and checkpoint_path.is_file():
        model = load_jepa2_from_checkpoint(checkpoint_path, device=device)
