"""Discover jepa2 model specs, checkpoint stages, and per-stage metrics JSON."""
...
from jepa2.metrics_paths import model_profile_json_path, stage_benchmarks_json_path, stage_metrics_json_path
from jepa2.model_spec import MODEL_CONFIGS_DIR, load_model_spec
...
def load_spec_by_model_name(name: str) -> dict[str, Any]:
    ...
    if not path.is_file():
        raise FileNotFoundError(f"No jepa2 spec for model {name!r}")
