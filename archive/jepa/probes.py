"""
Single-layer linear probes for JEPA encoder latents (same API spirit as embedding.probes).
"""
...
from jepa.config import PROBE_EPOCHS, PROBE_LR, PROBE_RANDOM_SEED
...
class LinearClassifierProbe(nn.Module):
    """Single linear layer: embed_dim -> 1. BCEWithLogitsLoss; sigmoid for proba."""
