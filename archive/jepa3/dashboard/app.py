"""FastAPI app for jepa3: catalog, per-stage metrics curves, benchmarks, training runner."""
...
from jepa3.dashboard.benchmark_infer import benchmark_forward_pass, cache_key_for_benchmark, count_parameters_for_spec
from jepa3.dashboard.orchestration import is_safe_model_name, next_missing_stage, spec_file_stem_exists
from jepa3.dashboard.scan import (
    list_models_catalog,
...
from jepa3.metrics_paths import model_profile_json_path, stage_benchmarks_json_path

_STATIC_DIR = Path(__file__).resolve().parent / "static"

app = FastAPI(title="jepa3 Training Dashboard", version="1.0.0")
...
async def health() -> dict[str, str]:
    return {"status": "ok", "package": "jepa3"}
