"""Map (B, 8, 8, 18) board tensors to per-square category IDs for embedding lookup.
...
Planes match the board-tensor channel layout documented in ``style_policy.packed_codec``:
pieces 0–11, turn 12, castling 13–16 (H1, A1, H8, A8 rights), EP target 17.
...
# Board dimensions — inlined to keep this file self-contained.
BOARD_HEIGHT = 8
BOARD_WIDTH = 8
BOARD_CHANNELS = 18
